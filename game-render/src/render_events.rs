...
impl RenderEventConsumer {
    ...
    fn handle_finish_turn(t: &GameAction) -> Vec<Animation> {
    ...
    fn handle_undo(t: &GameAction) -> Vec<Animation> {
    ...
    fn handle_attack(attack_event: &AttackCompoundEvent) -> Vec<Animation> {
        let mut animations: Vec<Animation> = vec![];
